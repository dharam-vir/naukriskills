            ...
            <div className="col-xl-6 col-md-12 col-sm-12">
              <div className="dashboard-box main-box-in-row">
                ...
                <div className="content">
                  <div className="chart">
                    <canvas id="canvas" width={80} height={38} />
                  </div>
                </div>
              </div>
            </div>
            <div className="col-xl-6 col-md-12 col-sm-12">
              <div className="dashboard-box main-box-in-row">
                ...
                <div className="content">
                      ...
                      <ul className="utf-dashboard-box-list">
                        <li>
                          ...
                          <div className="utf-buttons-to-right">
                            <a href="#" className="button green ripple-effect ico" title="Edit" data-tippy-placement="top"><i className="icon-feather-edit" /></a>
                  ...
                  <a href="#small-dialog" className="popup-with-zoom-anim utf-header-notifications-button ripple-effect utf-button-sliding-icon">User
                    Add Notes <i className="icon-feather-chevron-right" /></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="col-xl-6 col-md-12 col-sm-12">
              <div className="dashboard-box">
                ...
                <div className="content">
                  <ul className="utf-dashboard-box-list">
                    <li>
                      <span className="notification-icon"><i className="icon-material-outline-group" /></span> <span className="notification-text"> <strong>John Williams</strong> <a href="#">iOS Developers</a> Someone
                    ...
                    <li>
                      <span className="notification-icon"><i className="icon-feather-briefcase" /></span> <span className="notification-text"> <strong>John Williams</strong> <a href="#">iOS Developers</a> Someone
                        Downloaded Your Resume.</span>
                      <div className="utf-buttons-to-right">
                        <a href="#" className="button red ripple-effect ico" title="Remove" data-tippy-placement="top"><i className="icon-feather-trash-2" /></a>
                      </div>
                    ...
                    <li>
                      <span className="notification-icon"><i className="icon-feather-briefcase" /></span> <span className="notification-text"> <strong>John Williams</strong> <a href="#">Software Engineer</a>
                    ...
                    <li>
                      <span className="notification-icon"><i className="icon-material-outline-group" /></span> <span className="notification-text"> <strong>John Williams</strong> <a href="#">Logo Designer</a> Someone
                        Downloaded Your Resume.</span>
                      <div className="utf-buttons-to-right">
                        <a href="#" className="button red ripple-effect ico" title="Remove" data-tippy-placement="top"><i className="icon-feather-trash-2" /></a>
                      </div>
                    ...
                    <li>
                      <span className="notification-icon"><i className="icon-feather-briefcase" /></span> <span className="notification-text"> <strong>John Williams</strong> <a href="#">Web Designer</a> Someone
                        Downloaded Your Resume.</span>
                      <div className="utf-buttons-to-right">
                        <a href="#" className="button red ripple-effect ico" title="Remove" data-tippy-placement="top"><i className="icon-feather-trash-2" /></a>
                      </div>
                  ...
                  <ul className="utf-dashboard-box-list">
                    <li>
                      <div className="utf-invoice-list-item">
                        <div className="utf-invoice-user-city">Afghanistan <img className="flag" src="images/flags/af.svg" alt data-tippy-placement="top" title="Afghanistan" data-tippy /></div>
                      ...
                      <div className="utf-buttons-to-right"> <a href="invoice-template.html" className="button gray" title="Invoice" data-tippy-placement="top"><i className="icon-feather-printer" /> Invoice</a>
                      </div>
                    </li>
                    <li>
                      <div className="utf-invoice-list-item">
                        <div className="utf-invoice-user-city">United States <img className="flag" src="images/flags/us.svg" alt data-tippy-placement="top" title="United States" data-tippy /></div>
                        <strong>John Williams <span className="paid">Paid Plan</span></strong>
                        <ul>
                          <li><span>Order ID:</span> 004312641</li>
                    ...
                    <li>
                      <div className="utf-invoice-list-item">
                        <div className="utf-invoice-user-city">Australia <img className="flag" src="images/flags/au.svg" alt data-tippy-placement="top" title="Australia" data-tippy /></div>
                      ...
                      <div className="utf-buttons-to-right"> <a href="invoice-template.html" className="button red" title="Remove" data-tippy-placement="top"><i className="icon-feather-trash-2" /> Remove</a>
                      </div>
                    </li>
                    <li>
                      <div className="utf-invoice-list-item">
                        <div className="utf-invoice-user-city">Brazil <img className="flag" src="images/flags/br.svg" alt data-tippy-placement="top" title="Brazil" data-tippy /></div>
                        <strong>John Williams <span className="paid">Paid Plan</span></strong>
                        <ul>
                          <li><span>Order ID:</span> 004312641</li>
                          <li><span>Package:</span> Standard</li>
                ...
                <div className="dashboard-list-box table-responsive invoices with-icons">
                  <table className="table table-hover">
                    ...
                    <tbody>
                      <tr>
                        <td>0431261</td>
                        <td><img alt className="img-fluid rounded-circle shadow-lg" src="images/thumb-1.jpg" width={50} height={50} data-tippy-placement="top" title="John Williams" data-tippy /></td>
                        <td>Standard Plan</td>
                        <td>12 Dec 2021</td>
                        <td>Paypal</td>
                        <td><span className="badge badge-pill badge-primary text-uppercase">Approved</span></td>
                        <td><a href="#" className="button gray"><i className="icon-feather-eye" /> View Detail</a></td>
                      </tr>
                      <tr>
                        <td>0431262</td>
                        <td><img alt className="img-fluid rounded-circle shadow-lg" src="images/thumb-1.jpg" width={50} height={50} data-tippy-placement="top" title="John Williams" data-tippy /></td>
